...
func chapterTwo() {
    ...
    if pointTotal > teams[9].Score {
        print("Great job, coach! You Won against the \(teams[9].TeamName)!")
        
        totalWins += 1
    } else if pointTotal < teams[9].Score {
        print("Your team lost against the \(teams[9].TeamName), SOL!")
    ...
    func chant() -> String{
        ...
        if pointTotal > teams[10].Score {
            print("Great job, coach! You Won against the \(teams[10].TeamName)!")
            
            totalWins += 1
        } else if pointTotal < teams[10].Score {
            print( "Your team lost against the \(teams[10].TeamName), SOL!")
        ...
        if pointTotal > teams[11].Score {
            print("Great job, coach! You Won against the \(teams[11].TeamName)!")
            
            totalWins += 1
        } else if pointTotal < teams[11].Score {
            print("Your team lost against the \(teams[11].TeamName), SOL!")
        ...
        if pointTotal > teams[12].Score {
            print("Great job, coach! You Won against the \(teams[12].TeamName)!")
            
            totalWins += 1
        } else if pointTotal < teams[12].Score {
            print("Your team lost against the \(teams[12].TeamName), SOL!")
        ...
        //IF ELSE STATEMENT
        if pointTotal > teams[13].Score {
            print("Great job, coach! You Won against the \(teams[13].TeamName)!")
            
            totalWins += 1
        } else if pointTotal < teams[13].Score {
            print("Your team lost against the \(teams[13].TeamName), SOL!")
        ...
        if pointTotal > teams[14].Score {
            print("Great job, coach! You Won against the \(teams[14].TeamName)!")
            
            totalWins += 1
        } else if pointTotal < teams[14].Score {
            print("Your team lost against the \(teams[14].TeamName), SOL!")
